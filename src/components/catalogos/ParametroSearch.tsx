...
export default function ParametroSearch({ defaultValue = "" }: { defaultValue?: string }) {
  ...
  function handleSearch(term: string) {
    ...
    startTransition(() => {
      router.push(`/admin/catalogos/parametros?${params.toString()}`);
    });
  }
  ...
  return (
    <div className="relative w-full md:w-96 group">
      <Input
        ...
        placeholder="Buscar por clave, categoría o descripción..."
